...
(function ($) {
  ...
  function initPreview() {
    ...
    $('.merchant-cart-preview .cart-item-offer__container .offer-title').text(cartOfferTitle.replace('{min_quantity}', '3').replace('{offer_quantity}', '1'));
    $('.merchant-cart-preview .cart-item-offer__container .discount-savings .label').html(cartDiscountText.replace('{discount}', "<strong>20%</strong>"));
